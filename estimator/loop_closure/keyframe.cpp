...
void KeyFrame::buildKeyFrameFeatures(Estimator &estimator, const PinholeCameraPtr &m_camera)
{
...
void KeyFrame::FundmantalMatrixRANSAC(std::vector<cv::Point2f> &measurements_old,
	std::vector<cv::Point2f> &measurements_old_norm, const PinholeCameraPtr &m_camera)
{
